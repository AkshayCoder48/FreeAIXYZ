...
export const MODELS: readonly GatewayModel[] = [
  ...
  gf("anyprovider", "any-gpt-4o-mini-tts", "auto", "gpt-4o-mini-tts (via AnyProvider)", "AnyProvider", "professional", 128000),
  gf("anyprovider", "any-gpt-4-1-nano", "auto", "gpt-4.1-nano (via AnyProvider)", "AnyProvider", "professional", 128000),
  gf("anyprovider", "any-smart", "auto", "smart (via AnyProvider)", "AnyProvider", "professional", 128000),
  gf("anyprovider", "any-gpt-4o", "auto", "gpt-4o (via AnyProvider)", "AnyProvider", "professional", 128000),
  gf("anyprovider", "any-reasoning", "auto", "reasoning (via AnyProvider)", "AnyProvider", "reasoning", 128000),
  gf("anyprovider", "any-gpt-4", "auto", "gpt-4 (via AnyProvider)", "AnyProvider", "professional", 128000),
  gf("anyprovider", "any-study", "auto", "study (via AnyProvider)", "AnyProvider", "professional", 128000),
  gf("anyprovider", "any-gpt-image", "auto", "gpt-image (via AnyProvider)", "AnyProvider", "professional", 128000),
  gf("anyprovider", "any-search", "auto", "search (via AnyProvider)", "AnyProvider", "professional", 128000),
  gf("anyprovider", "any-command-r", "auto", "command-r (via AnyProvider)", "AnyProvider", "professional", 256000),
  gf("anyprovider", "any-command-a", "auto", "command-a (via AnyProvider)", "AnyProvider", "professional", 128000),
  gf("anyprovider", "any-command-r-plus", "auto", "command-r-plus (via AnyProvider)", "AnyProvider", "professional", 256000),
  gf("anyprovider", "any-command-r7b", "auto", "command-r7b (via AnyProvider)", "AnyProvider", "professional", 256000),
  gf("anyprovider", "any-deepseek-r1", "auto", "deepseek-r1 (via AnyProvider)", "AnyProvider", "reasoning", 64000),
  gf("anyprovider", "any-aria", "auto", "aria (via AnyProvider)", "AnyProvider", "professional", 128000),
  gf("anyprovider", "any-r1-1776", "auto", "r1-1776 (via AnyProvider)", "AnyProvider", "reasoning", 128000),
  gf("anyprovider", "any-sd-3-5-large", "auto", "sd-3.5-large (via AnyProvider)", "AnyProvider", "professional", 128000),
  gf("anyprovider", "any-openai-fast", "auto", "openai-fast (via AnyProvider)", "AnyProvider", "professional", 128000),
  gf("anyprovider", "any-openai", "auto", "openai (via AnyProvider)", "AnyProvider", "professional", 128000),
  gf("anyprovider", "any-chat", "auto", "chat (via AnyProvider)", "AnyProvider", "professional", 128000),
  gf("anyprovider", "any-nova", "auto", "nova (via AnyProvider)", "AnyProvider", "professional", 128000),
  gf("anyprovider", "any-perplexity", "auto", "perplexity (via AnyProvider)", "AnyProvider", "professional", 128000),
  gf("anyprovider", "any-sana", "auto", "sana (via AnyProvider)", "AnyProvider", "professional", 128000),
  gf("anyprovider", "any-qwen-3-6-27b", "auto", "qwen-3.6-27b (via AnyProvider)", "AnyProvider", "professional", 262144),
  gf("anyprovider", "any-qwen-3-7-plus", "auto", "qwen-3.7-plus (via AnyProvider)", "AnyProvider", "professional", 262144),
  gf("anyprovider", "any-qwen-3-7-max", "auto", "qwen-3.7-max (via AnyProvider)", "AnyProvider", "professional", 262144),
  gf("anyprovider", "any-qwen-3-6-max", "auto", "qwen-3.6-max (via AnyProvider)", "AnyProvider", "professional", 262144),
  gf("anyprovider", "any-qwen-3-5-plus", "auto", "qwen-3.5-plus (via AnyProvider)", "AnyProvider", "professional", 262144),
  gf("anyprovider", "any-qwen-3-omni-flash", "auto", "qwen-3-omni-flash (via AnyProvider)", "AnyProvider", "professional", 262144),
  gf("anyprovider", "any-qwen-3-5-flash", "auto", "qwen-3.5-flash (via AnyProvider)", "AnyProvider", "professional", 262144),
  gf("anyprovider", "any-qwen-plus", "auto", "qwen-plus (via AnyProvider)", "AnyProvider", "professional", 262144),
  gf("anyprovider", "any-qwen-3-5-omni-plus", "auto", "qwen-3.5-omni-plus (via AnyProvider)", "AnyProvider", "professional", 262144),
  gf("anyprovider", "any-qwen-3-5-omni-flash", "auto", "qwen-3.5-omni-flash (via AnyProvider)", "AnyProvider", "professional", 262144),
  gf("anyprovider", "any-qwen-3-coder-plus", "auto", "qwen-3-coder-plus (via AnyProvider)", "AnyProvider", "professional", 262144),
  gf("anyprovider", "any-qwen-3-max", "auto", "qwen-3-max (via AnyProvider)", "AnyProvider", "professional", 262144),
  gf("anyprovider", "any-qwen-3-6-35b-a3b", "auto", "qwen-3.6-35b-a3b (via AnyProvider)", "AnyProvider", "professional", 262144),
  gf("anyprovider", "any-qwen-3-5-397b-a17b", "auto", "qwen-3.5-397b-a17b (via AnyProvider)", "AnyProvider", "professional", 262144),
  gf("anyprovider", "any-qwen-3-vl-plus", "auto", "qwen-3-vl-plus (via AnyProvider)", "AnyProvider", "professional", 262144),
  gf("anyprovider", "any-command-r-plus24", "auto", "command-r-plus24 (via AnyProvider)", "AnyProvider", "professional", 256000),
  gf("anyprovider", "any-gpt-5-nano", "auto", "gpt-5-nano (via AnyProvider)", "AnyProvider", "professional", 128000),
  gf("anyprovider", "any-gpt-5-4-nano", "auto", "gpt-5.4-nano (via AnyProvider)", "AnyProvider", "professional", 128000),
  gf("anyprovider", "any-command-r7b24", "auto", "command-r7b24 (via AnyProvider)", "AnyProvider", "professional", 256000),
  gf("anyprovider", "any-command-r24", "auto", "command-r24 (via AnyProvider)", "AnyProvider", "professional", 256000),
  gf("anyprovider", "any-command-r7b-arabic25", "auto", "command-r7b-arabic25 (via AnyProvider)", "AnyProvider", "professional", 256000),
  gf("anyprovider", "any-command-a25", "auto", "command-a25 (via AnyProvider)", "AnyProvider", "professional", 128000),
  gf("anyprovider", "any-pplx-pro", "auto", "pplx_pro (via AnyProvider)", "AnyProvider", "professional", 128000),

  // ─── BlackForestLabs_Flux1Dev (BlackForest Labs Flux) — 1 models ──────────────
  gf("bfl-flux", "bfl-flux-dev", "auto", "flux-dev (via BlackForest Labs Flux)", "BlackForestLabs_Flux1Dev", "professional", 128000),

  // ─── HuggingSpace (HuggingFace Space) — 7 models ──────────────
  gf("huggingspace", "hf-command-a-03-2025", "auto", "command-a-03-2025 (via HuggingFace Space)", "HuggingSpace", "professional", 128000),
  gf("huggingspace", "hf-command-r-plus-08-2024", "auto", "command-r-plus-08-2024 (via HuggingFace Space)", "HuggingSpace", "professional", 256000),
  gf("huggingspace", "hf-command-a", "auto", "command-a (via HuggingFace Space)", "HuggingSpace", "professional", 128000),
  gf("huggingspace", "hf-command-r7b-arabic-02-2025", "auto", "command-r7b-arabic-02-2025 (via HuggingFace Space)", "HuggingSpace", "professional", 256000),
  gf("huggingspace", "hf-command-r-08-2024", "auto", "command-r-08-2024 (via HuggingFace Space)", "HuggingSpace", "professional", 256000),
  gf("huggingspace", "hf-command-r7b-12-2024", "auto", "command-r7b-12-2024 (via HuggingFace Space)", "HuggingSpace", "professional", 256000),
  gf("huggingspace", "hf-command-r", "auto", "command-r (via HuggingFace Space)", "HuggingSpace", "professional", 256000),

  // ─── OpenAIFM (OpenAI.fm) — 17 models ──────────────
  gf("openaifm", "ofm-ballad", "auto", "ballad (via OpenAI.fm)", "OpenAIFM", "professional", 128000),
  gf("openaifm", "ofm-scientific-style", "auto", "scientific_style (via OpenAI.fm)", "OpenAIFM", "professional", 128000),
  gf("openaifm", "ofm-ash", "auto", "ash (via OpenAI.fm)", "OpenAIFM", "professional", 128000),
  gf("openaifm", "ofm-calm", "auto", "calm (via OpenAI.fm)", "OpenAIFM", "professional", 128000),
  gf("openaifm", "ofm-coral", "auto", "coral (via OpenAI.fm)", "OpenAIFM", "professional", 128000),
  gf("openaifm", "ofm-alloy", "auto", "alloy (via OpenAI.fm)", "OpenAIFM", "professional", 128000),
  gf("openaifm", "ofm-friendly", "auto", "friendly (via OpenAI.fm)", "OpenAIFM", "professional", 128000),
  gf("openaifm", "ofm-noir-detective", "auto", "noir_detective (via OpenAI.fm)", "OpenAIFM", "professional", 128000),
  gf("openaifm", "ofm-cowboy", "auto", "cowboy (via OpenAI.fm)", "OpenAIFM", "professional", 128000),
  gf("openaifm", "ofm-patient-teacher", "auto", "patient_teacher (via OpenAI.fm)", "OpenAIFM", "professional", 128000),
  gf("openaifm", "ofm-sage", "auto", "sage (via OpenAI.fm)", "OpenAIFM", "professional", 128000),
  gf("openaifm", "ofm-fable", "auto", "fable (via OpenAI.fm)", "OpenAIFM", "professional", 128000),
  gf("openaifm", "ofm-onyx", "auto", "onyx (via OpenAI.fm)", "OpenAIFM", "professional", 128000),
  gf("openaifm", "ofm-shimmer", "auto", "shimmer (via OpenAI.fm)", "OpenAIFM", "professional", 128000),
  gf("openaifm", "ofm-nova", "auto", "nova (via OpenAI.fm)", "OpenAIFM", "professional", 128000),
  gf("openaifm", "ofm-verse", "auto", "verse (via OpenAI.fm)", "OpenAIFM", "professional", 128000),
  gf("openaifm", "ofm-echo", "auto", "echo (via OpenAI.fm)", "OpenAIFM", "professional", 128000),

  // ─── OperaAria (Opera Aria) — 1 models ──────────────
  gf("opera-aria", "opera-aria", "auto", "aria (via Opera Aria)", "OperaAria", "professional", 128000),

  // ─── Perplexity (Perplexity) — 13 models ──────────────
  gf("perplexity-g4f", "pplx-auto", "auto", "auto (via Perplexity)", "Perplexity", "professional", 128000),
  gf("perplexity-g4f", "pplx-o3pro", "auto", "o3pro (via Perplexity)", "Perplexity", "professional", 128000),
  gf("perplexity-g4f", "pplx-pplx-alpha", "auto", "pplx_alpha (via Perplexity)", "Perplexity", "professional", 128000),
  gf("perplexity-g4f", "pplx-pplx-pro-upgraded", "auto", "pplx_pro_upgraded (via Perplexity)", "Perplexity", "professional", 128000),
  gf("perplexity-g4f", "pplx-gpt5-thinking", "auto", "gpt5_thinking (via Perplexity)", "Perplexity", "reasoning", 128000),
  gf("perplexity-g4f", "pplx-claude45sonnet", "auto", "claude45sonnet (via Perplexity)", "Perplexity", "professional", 128000),
  gf("perplexity-g4f", "pplx-experimental", "auto", "experimental (via Perplexity)", "Perplexity", "professional", 128000),
  gf("perplexity-g4f", "pplx-gpt41", "auto", "gpt41 (via Perplexity)", "Perplexity", "professional", 128000),
  gf("perplexity-g4f", "pplx-claude37sonnetthinking", "auto", "claude37sonnetthinking (via Perplexity)", "Perplexity", "reasoning", 128000),
  gf("perplexity-g4f", "pplx-gemini2flash", "auto", "gemini2flash (via Perplexity)", "Perplexity", "professional", 1000000),
  gf("perplexity-g4f", "pplx-claude40opusthinking", "auto", "claude40opusthinking (via Perplexity)", "Perplexity", "reasoning", 128000),
  gf("perplexity-g4f", "pplx-o4mini", "auto", "o4mini (via Perplexity)", "Perplexity", "professional", 128000),
  gf("perplexity-g4f", "pplx-pplx-reasoning", "auto", "pplx_reasoning (via Perplexity)", "Perplexity", "reasoning", 128000),

  // ─── Pollinations (Pollinations) — 4 models ──────────────
  gf("pollinations-g4f", "polg-openai-fast", "auto", "openai-fast (via Pollinations)", "Pollinations", "professional", 128000),
  gf("pollinations-g4f", "polg-openai", "auto", "openai (via Pollinations)", "Pollinations", "professional", 128000),
  gf("pollinations-g4f", "polg-gpt-oss", "auto", "gpt-oss (via Pollinations)", "Pollinations", "professional", 128000),
  gf("pollinations-g4f", "polg-sana", "auto", "sana (via Pollinations)", "Pollinations", "professional", 128000),

  // ─── PollinationsImage (Pollinations Image) — 1 models ──────────────
  gf("pollinations-image", "polimg-sana-2", "auto", "sana (via Pollinations Image)", "PollinationsImage", "professional", 128000),

  // ─── Qwen (Qwen Chat) — 16 models ──────────────
  gf("qwen-chat", "qwenchat-qwen3-5-flash", "auto", "qwen3.5-flash (via Qwen Chat)", "Qwen", "professional", 262144),
  gf("qwen-chat", "qwenchat-qwen3-6-27b", "auto", "qwen3.6-27b (via Qwen Chat)", "Qwen", "professional", 262144),
  gf("qwen-chat", "qwenchat-qwen3-6-plus", "auto", "qwen3.6-plus (via Qwen Chat)", "Qwen", "professional", 262144),
  gf("qwen-chat", "qwenchat-qwen3-6-35b-a3b", "auto", "qwen3.6-35b-a3b (via Qwen Chat)", "Qwen", "professional", 262144),
  gf("qwen-chat", "qwenchat-qwen3-7-max", "auto", "qwen3.7-max (via Qwen Chat)", "Qwen", "professional", 262144),
  gf("qwen-chat", "qwenchat-qwen3-7-plus", "auto", "qwen3.7-plus (via Qwen Chat)", "Qwen", "professional", 262144),
  gf("qwen-chat", "qwenchat-qwen3-5-plus", "auto", "qwen3.5-plus (via Qwen Chat)", "Qwen", "professional", 262144),
  gf("qwen-chat", "qwenchat-qwen3-5-omni-plus", "auto", "qwen3.5-omni-plus (via Qwen Chat)", "Qwen", "professional", 262144),
  gf("qwen-chat", "qwenchat-qwen3-6-max-preview", "auto", "qwen3.6-max-preview (via Qwen Chat)", "Qwen", "professional", 262144),
  gf("qwen-chat", "qwenchat-qwen3-5-397b-a17b", "auto", "qwen3.5-397b-a17b (via Qwen Chat)", "Qwen", "professional", 262144),
  gf("qwen-chat", "qwenchat-qwen3-omni-flash-2025-12-01", "auto", "qwen3-omni-flash-2025-12-01 (via Qwen Chat)", "Qwen", "professional", 262144),
  gf("qwen-chat", "qwenchat-qwen3-5-omni-flash", "auto", "qwen3.5-omni-flash (via Qwen Chat)", "Qwen", "professional", 262144),
  gf("qwen-chat", "qwenchat-qwen3-coder-plus", "auto", "qwen3-coder-plus (via Qwen Chat)", "Qwen", "professional", 262144),
  gf("qwen-chat", "qwenchat-qwen-plus-2025-07-28", "auto", "qwen-plus-2025-07-28 (via Qwen Chat)", "Qwen", "professional", 262144),
  gf("qwen-chat", "qwenchat-qwen3-max-2026-01-23", "auto", "qwen3-max-2026-01-23 (via Qwen Chat)", "Qwen", "professional", 262144),
  gf("qwen-chat", "qwenchat-qwen3-vl-plus", "auto", "qwen3-vl-plus (via Qwen Chat)", "Qwen", "professional", 262144),

  // ─── WeWordle (WeWordle) — 7 models ──────────────
  gf("wewordle", "ww-gpt-4o-mini", "auto", "gpt-4o-mini (via WeWordle)", "WeWordle", "professional", 128000),
  gf("wewordle", "ww-gpt-4o", "auto", "gpt-4o (via WeWordle)", "WeWordle", "professional", 128000),
  gf("wewordle", "ww-gpt-4", "auto", "gpt-4 (via WeWordle)", "WeWordle", "professional", 128000),
  gf("wewordle", "ww-v3", "auto", "v3 (via WeWordle)", "WeWordle", "professional", 128000),
  gf("wewordle", "ww-deepseek", "auto", "deepseek (via WeWordle)", "WeWordle", "professional", 64000),
  gf("wewordle", "ww-deepseek-reasoner", "auto", "deepseek-reasoner (via WeWordle)", "WeWordle", "professional", 64000),
  gf("wewordle", "ww-deepseek-r1", "auto", "deepseek-r1 (via WeWordle)", "WeWordle", "reasoning", 64000),

  // ─── Yqcloud (Yqcloud) — 1 models ──────────────
  gf("yqcloud", "yq-gpt-4", "auto", "gpt-4 (via Yqcloud)", "Yqcloud", "professional", 128000),
