  ...
  return (
    <div className="relative min-h-screen flex flex-col bg-background overflow-x-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(60% 50% at 50% 0%, rgba(44,224,128,0.12), transparent 70%), radial-gradient(40% 40% at 100% 100%, rgba(44,224,128,0.06), transparent 70%)",
        }}
      />
      <div
        aria-hidden
      ...
      <header className="sticky top-0 z-40 border-b border-border/60 bg-background/80 backdrop-blur-xl">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="relative h-9 w-9 rounded-xl bg-[#2ce080]/10 border border-[#2ce080]/30 flex items-center justify-center">
              <Zap className="h-5 w-5 text-[#2ce080]" />
            </div>
            <div className="leading-tight">
              <span className="block text-sm font-semibold tracking-tight">
                FreeGPT<span className="text-[#2ce080]"> Gateway</span>
              </span>
          ...
          <div className="flex items-center gap-2">
            <Badge
              variant="outline"
              className="hidden sm:inline-flex gap-1.5 border-[#2ce080]/30 text-[#2ce080] bg-[#2ce080]/5"
            >
              <span className="relative flex h-1.5 w-1.5">
                <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[#2ce080] opacity-70" />
      ...
      <main className="flex-1">
        ...
        <section className="relative mx-auto max-w-6xl px-4 sm:px-6 pt-16 sm:pt-24 pb-12">
          <div className="flex flex-col items-center text-center gap-6">
            <Badge
              variant="outline"
              className="gap-1.5 border-[#2ce080]/30 text-[#2ce080] bg-[#2ce080]/5 px-3 py-1"
            >
            ...
            <h1 className="text-4xl sm:text-6xl font-bold tracking-tight text-balance max-w-4xl">
              Unlimited free AI,{" "}
              <span className="bg-gradient-to-r from-[#2ce080] to-[#7ff3b3] bg-clip-text text-transparent">
                no key required
              </span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 pt-2">
              <Button
                asChild
                size="lg"
                className="bg-[#2ce080] hover:bg-[#22b569] text-[#042330] h-12 px-6"
              >
                <a href="/chat">
            ...
            <div className="mt-8 grid grid-cols-2 sm:grid-cols-4 gap-3 w-full max-w-3xl">
              {[
                ...
                >
                  <div className="text-2xl font-bold text-[#2ce080]">
                    {big}
                  </div>
          ...
          <div className="mb-6 flex items-end justify-between flex-wrap gap-3">
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                ...
                <code className="text-[#2ce080] text-xs">
        ...
        >
          <div className="text-center mb-10">
            ...
            <p className="text-sm text-muted-foreground mt-2 max-w-xl mx-auto">
              Everything you&apos;d want from a free AI endpoint, with none of
              the usual gates.
            </p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {FEATURES.map((f) => (
              <div
                key={f.title}
                className="group rounded-2xl border border-border bg-card/40 backdrop-blur p-5 hover:border-[#2ce080]/40 hover:bg-card/60 transition-colors"
              >
                <div className="h-11 w-11 rounded-xl bg-[#2ce080]/10 border border-[#2ce080]/20 flex items-center justify-center mb-4 group-hover:scale-105 transition-transform">
        ...
        <section
          ...
          className="mx-auto max-w-6xl px-4 sm:px-6 py-12 scroll-mt-20"
        >
          <div className="rounded-3xl border border-border bg-gradient-to-b from-[#2ce080]/[0.04] to-transparent p-6 sm:p-10">
            <div className="text-center mb-10">
              <Badge
                variant="outline"
                className="mb-3 border-[#2ce080]/30 text-[#2ce080] bg-[#2ce080]/5"
              >
                ...
                <div key={s.n} className="relative">
                  <div className="rounded-2xl border border-border bg-card/60 backdrop-blur p-6 h-full">
                    <div className="flex items-center justify-between mb-4">
                      <span className="text-3xl font-bold text-[#2ce080]/30">
                        {s.n}
                      </span>
                      <div className="h-10 w-10 rounded-lg bg-[#2ce080]/10 border border-[#2ce080]/20 flex items-center justify-center">
                        <s.icon className="h-5 w-5 text-[#2ce080]" />
                      </div>
                    </div>
                  ...
                  {i < ROTATION_STEPS.length - 1 && (
                    <ArrowRight className="hidden md:block absolute -right-3 top-1/2 -translate-y-1/2 h-5 w-5 text-[#2ce080]/40 z-10" />
                  )}
                </div>
              ))}
            </div>
        ...
        >
          <div className="grid lg:grid-cols-[1fr_1.4fr] gap-8 items-start">
            <div className="lg:sticky lg:top-24">
              <Badge variant="outline" className="mb-3 border-[#2ce080]/30 text-[#2ce080] bg-[#2ce080]/5">
              ...
              <ul className="mt-5 space-y-2.5 text-sm">
                {[
                  ...
                  <li key={t} className="flex items-start gap-2">
                    <CheckCircle2 className="h-4 w-4 text-[#2ce080] mt-0.5 shrink-0" />
