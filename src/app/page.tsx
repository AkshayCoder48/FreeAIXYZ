      ...
      <header className="sticky top-0 z-40 border-b border-border/60 bg-background/80 backdrop-blur-xl">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="relative h-9 w-9 rounded-xl bg-[#ff9a3c]/10 border border-[#ff9a3c]/30 flex items-center justify-center">
          ...
          <div className="flex items-center gap-2">
            <Badge
              variant="outline"
              className="hidden sm:inline-flex gap-1.5 border-[#ff9a3c]/30 text-[#ff9a3c] bg-[#ff9a3c]/5"
            >
              <span className="relative flex h-1.5 w-1.5">
                <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[#ff9a3c] opacity-70" />
      ...
      <main className="flex-1">
        ...
        <section className="relative mx-auto max-w-6xl px-4 sm:px-6 pt-16 sm:pt-24 pb-12">
          <div className="flex flex-col items-center text-center gap-6">
            <Badge
              variant="outline"
              className="gap-1.5 border-[#ff9a3c]/30 text-[#ff9a3c] bg-[#ff9a3c]/5 px-3 py-1"
            >
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 pt-2">
              <Button
                asChild
                size="lg"
                className="bg-[#ff9a3c] hover:bg-[#f08820] text-[#000000] h-12 px-6"
              >
                <a href="/chat">
            ...
            <div className="mt-8 grid grid-cols-2 sm:grid-cols-4 gap-3 w-full max-w-3xl">
              {[
                ...
                >
                  <div className="text-2xl font-bold text-[#ff9a3c]">
                    {big}
                  </div>
          ...
          <div className="mb-6 flex items-end justify-between flex-wrap gap-3">
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                ...
                <code className="text-[#ff9a3c] text-xs">
        ...
        >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {FEATURES.map((f) => (
              <div
                key={f.title}
                className="group rounded-2xl border border-border bg-card/40 backdrop-blur p-5 hover:border-[#ff9a3c]/40 hover:bg-card/60 transition-colors"
              >
        ...
        <section
          ...
          className="mx-auto max-w-6xl px-4 sm:px-6 py-12 scroll-mt-20"
        >
          <div className="rounded-3xl border border-border bg-gradient-to-b from-[#ff9a3c]/[0.04] to-transparent p-6 sm:p-10">
            <div className="text-center mb-10">
              <Badge
                variant="outline"
                className="mb-3 border-[#ff9a3c]/30 text-[#ff9a3c] bg-[#ff9a3c]/5"
              >
                ...
                <div key={s.n} className="relative">
                  <div className="rounded-2xl border border-border bg-card/60 backdrop-blur p-6 h-full">
                    <div className="flex items-center justify-between mb-4">
                      <span className="text-3xl font-bold text-[#ff9a3c]/30">
                        {s.n}
                      </span>
                      <div className="h-10 w-10 rounded-lg bg-[#ff9a3c]/10 border border-[#ff9a3c]/20 flex items-center justify-center">
                  ...
                  {i < ROTATION_STEPS.length - 1 && (
                    <ArrowRight className="hidden md:block absolute -right-3 top-1/2 -translate-y-1/2 h-5 w-5 text-[#ff9a3c]/40 z-10" />
                  )}
                </div>
              ))}
            </div>
              ...
              <ul className="mt-5 space-y-2.5 text-sm">
                {[
                  ...
                  <li key={t} className="flex items-start gap-2">
                    <CheckCircle2 className="h-4 w-4 text-[#ff9a3c] mt-0.5 shrink-0" />
