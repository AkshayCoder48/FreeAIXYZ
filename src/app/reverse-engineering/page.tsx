    ...
    <div className="relative min-h-screen flex flex-col bg-background">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="flex items-center gap-2">
              <div className="h-7 w-7 rounded-lg bg-[#ff9a3c]/10 border border-[#ff9a3c]/30 flex items-center justify-center">
                <Shield className="h-4 w-4 text-[#ff9a3c]" />
              </div>
      ...
      <main className="flex-1 mx-auto max-w-5xl w-full px-4 sm:px-6 py-10">
        ...
        <div className="mb-10">
          <Badge
            variant="outline"
            className="gap-1.5 border-[#ff9a3c]/30 text-[#ff9a3c] bg-[#ff9a3c]/5 mb-4"
          >
...
client ◀── SSE stream { choices: [{ delta: { content } }] }`}
          ...
          {TRICKS.map((trick) => (
            ...
            >
              <div className="flex items-start gap-3 mb-3">
                <div className="h-10 w-10 rounded-lg bg-[#ff9a3c]/10 border border-[#ff9a3c]/30 flex items-center justify-center shrink-0">
                  <trick.icon className="h-5 w-5 text-[#ff9a3c]" />
                </div>
        ...
        {/* Files involved */}
        <div className="mt-10 rounded-2xl border border-[#ff9a3c]/30 bg-[#ff9a3c]/5 p-6">
          <h2 className="text-lg font-bold mb-3 flex items-center gap-2">
            <Code className="h-5 w-5 text-[#ff9a3c]" /> Files Involved
          </h2>
          <ul className="space-y-1.5 text-sm text-muted-foreground">
            <li>
              <code className="text-[#ff9a3c]">src/lib/providers/freegpt.ts</code>{" "}
              (543 lines) — Provider implementation: challenge handshake, header
              construction, SSE parsing, rate limiting
            </li>
            <li>
              <code className="text-[#ff9a3c]">src/lib/freegpt-signer.cjs</code>{" "}
              (286 lines) — WASM loader + browser API mocks + wasm-bindgen
              import shims
            </li>
            <li>
              <code className="text-[#ff9a3c]">wasm_signer_bg.wasm</code> (46KB) —
              The extracted WASM binary that computes PoW hashes + signatures
            </li>
            <li>
              <code className="text-[#ff9a3c]">wasm_signer.js</code> (13.8KB) —
              Original wasm-bindgen glue (reference, not loaded directly)
            </li>
            <li>
              <code className="text-[#ff9a3c]">src/lib/dsml-parser.ts</code> —
